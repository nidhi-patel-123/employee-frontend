...
function Add() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`https://employee-api-jet.vercel.app/api/leave/add`, leave, {
                headers: {
        ...
        <div className='max-w-4xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md'>
            ...
            <form onSubmit={handleSubmit}>
                <div className='flex flex-col space-y-4'>
                    <div>
                        <label className='block text-sm font-medium text-gray-7000'>Leave Type</label>
