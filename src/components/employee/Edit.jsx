...
import { fetchDepartments } from '../../utlis/EmployeeHelper'
...
function Edit() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://employee-api-jet.vercel.app/api/employee/${id}`, employee, {
                headers: {
                    "Authorization": `Bearer ${localStorage.getItem('token')} `
                }
            })
                ...
                <form onSubmit={handleSubmit}>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            <input type="number" name='salary' onChange={handleChange} value={employee.salary} placeholder='Salary' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required />
