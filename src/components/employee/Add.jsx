...
function Add() {
    ...
    const handleSubmit = async (e) => {
        ...
        Object.keys(formData).forEach((key) => {
         ...
         try {
      const response = await axios.post('https://employee-api-jet.vercel.app/api/employee/add', formDataObj, {
        headers: {
            ...
            <form onSubmit={handleSubmit}>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div>
                        ...
                        <input type="email" name='email' onChange={handleChange} placeholder='Insert Name' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required />
                    </div>
                    {/* Employee Id */}
                    <div>
